    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ExamScreen(listQuestion: questions, isMultichoice: _multichoice, isWrite: _write,)
                        )
                    );
                  },
          ...
          Text("Question type", style: TextStyle(color: Colors.grey),),
              ...
              if (!_write&& !value){
                showDialog(
                  ...
                  builder: (_) =>  AlertDialog(
                    ...
                    content: Text("Ban phai kich hoat it nhat mot loai cau hoi"),
                    actions: [
                      TextButton(
